...
import { motion } from "framer-motion";
import "./aboutUs.css";
import member1 from "../images/team/image1.png";
import member2 from "../images/team/image2.png";
import member3 from "../images/team/image8.jpg";
import member4 from "../images/team/image4.png";
import member5 from "../images/team/image5.png";
import member6 from "../images/team/image6.png";
import member7 from "../images/team/image7.png";
...
const AboutUs = () => {
  ...
  return (
    <div>
      <section id="about-us" className="about-us px-6 md:px-16 lg:px-52">
        <div className="mb-10">
          <motion.p
            className="text-xl my-2 text-start text-[#FF9500]"
            initial={{ opacity: 0, y: 20 }}
          ...
          <motion.p
            className="text-2xl md:text-4xl my-2 text-white font-bold text-start"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.0 }}
          >
