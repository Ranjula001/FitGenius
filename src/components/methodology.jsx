...
function Methodology() {
  return (
    <div className="text-white bg-black my-4 px-4 md:px-16 lg:px-60" id="Methodology">
      <motion.p
        className="text-2xl md:text-4xl my-2 font-bold text-start"
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 1.0 }}
      >
      ...
      <motion.div
          className="bg-gray-800 p-4 rounded-lg shadow-lg xl:hidden"
          initial={{ opacity: 0, scale: 0.9 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ duration: 1.0 }}
        >
          <img src={d1} alt="Methodology Diagram 1" className="w-full h-auto object-contain" />
          <p className="text-center text-sm mt-2">Figure 1</p>
        </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-10">
        <motion.div
          className="bg-gray-800 p-4 rounded-lg shadow-lg xl:block hidden"
          initial={{ opacity: 0, scale: 0.9 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ duration: 1.0 }}
        >
        ...
        <motion.div
          ...
          transition={{ duration: 1.0 }}
        >
          <img src={d2} alt="Methodology Diagram 2" className="w-full h-auto object-contain" />
          <p className="text-center text-sm mt-2">Figure 2</p>
        </motion.div>
      </div>
    </div>
