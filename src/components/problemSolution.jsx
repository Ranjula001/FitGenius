...
function ProblemSolution() {
  return (
    <div className="text-white bg-black py-8 px-4 md:px-16 lg:px-60" id="ResearchProblemSolution">
      <div className="text-center mb-12">
        <motion.p
        ...
        <motion.h2
          ...
          transition={{ duration: 1.0 }}
        >
          How can we provide personalized fitness plans and real-time feedback based on individual body types?
        </motion.h2>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="w-full">
          <img src={image} className="w-full h-auto" alt="Problem Solution" />
        </div>
        <div>
          <motion.p
