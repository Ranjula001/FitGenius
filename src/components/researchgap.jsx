...
function ResearchGap() {
  return (
    <div className="text-white bg-black py-8 px-4 md:px-16 lg:px-60" id="ResearchGap">
      <div className="text-center mb-12">
        <motion.p
      ...
      <div>
          <img src={RG} className="w-full xl:hidden" alt="Research Gap" />
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 justify-items-center">
        ...
        <div>
          <img src={RG} className="w-full xl:block hidden" alt="Research Gap" />
        </div>
      </div>
    </div>
  );
